...
// 
  ...
  onenote_web_desc: "The official web app for Microsoft OneNote on the unified cloud.microsoft domain, providing seamless cross-device note-taking, canvas organization, and digital notebook management.",
  ...
  foodpanda_name: "Foodpanda PH",
  foodpanda_desc: "Opens Foodpanda Philippines, an online food and grocery delivery platform where users can order meals, snacks, drinks, essentials, and supermarket items from nearby restaurants and stores. Browse menus, track deliveries in real time, and enjoy convenient on-demand service across the Philippines.",
