...
const L = {
  ...
  "install_desc": "Install",
  "install_wrapper_desc": "Install Wrapper",
  "installsucc_desc": "Install Succeeded",
  "tryinstallmanually_desc": "Try install manually",
  "installfailed_desc": "Install Failed",
  ...
  "apps_on_page": "apps on this page",
  "show_label": "Show",
  "per_page": "per page",
  "page_label": "Page",
  "of_label": "of",
...
// 
  ...
  epochconverter_desc: "Epoch Converter is a utility site that converts Unix timestamps to human-readable dates and vice versa. It also provides tools for working with time zones, daylight saving time, and current epoch values.",
  ...
  pwaplayer_desc: "A lightweight, FOSS media player and the author's first PWA project. Now a full-featured application, it offers a secure, sandboxed alternative to native players like VLC and MPV, supporting Nightcore playback, IPTV streams, and smooth speed control across all platforms.",
  pwaplayer_githubpagesmirror_name: "PWA Player (GitHub Pages Mirror)",
  pwaplayer_githubpagesmirror_desc: "The official GitHub Pages mirror of PWA Player. Note: GitHub Pages is blocked in mainland China; please use the Cloudflare-backed version if you are accessing from China.",
  ...
  pwastore_githubpagesmirror_name: "PWA Store (GitHub Pages Mirror)",
  pwastore_githubpagesmirror_desc: "The official GitHub Pages mirror of this PWA Store. Note: GitHub Pages is blocked in mainland China; users in China should use the Cloudflare main-site for access.",
  ...
  whitenoisegenerator_name: "White Noise Generator",
  ...
  notepadjs_desc: "Opens Notepad.js, a simple browser-based text editor built with JavaScript.",
  ...
  ilovesvg_desc: "A handy online utility platform for processing SVG vectors, offering efficient tools for SVG optimization, compression, and format conversion.",
  ...
  wechatmoney_desc: "Opens WeChat’s Money feature, allowing you to show your payment QR code or scan others to send money.",
  wechatscan_name: "Scan (扫一扫)",
  ...
  veniceai_desc: "Opens Venice AI, a private, decentralized, uncensored AI platform for text, image, and code generation.",
  duckai_name: "Duck.ai",
  ...
  google_aistudio_name: "Google AI Studio",
  google_aistudio_desc: "A web-based prototyping environment by Google for developers to experiment with Gemini models, test prompts, manage API keys, and build AI applications.",
  google_ai_dev_name: "Google AI for Developers",
  google_ai_dev_desc: "Official documentation and developer portal for Google's AI technologies. Access guides, API references, and SDKs for Gemini, Gemma open models, and MediaPipe.",
  ...
  nextaidrawio_desc: "Next AI Draw.io is a self‑hosted deployment of the open‑source Next.js application that integrates AI with draw.io. It allows users to generate, edit, and optimize diagrams through natural‑language commands, supporting architecture diagrams, flowcharts, and AI‑assisted visualization.",
  drawio_name: "Draw.io",
  ...
  nanocell_csv_name: "Nanocell CSV",
  ...
  githubdocs_name: "GitHub Docs",
  githubdocs_desc: "Opens GitHub Docs, the official documentation for GitHub, Git, APIs, Actions, and developer tools.",
  vscode_name: "VS Code",
  vscode_desc: "Online Visual Studio Code Web editor.",
  vscode_insider_name: "VS Code Insider",
  vscode_insider_desc: "Preview build of Visual Studio Code Web editor.",
  ...
  webserialterminal_name: "Web Serial Terminal",
  ...
  llvm_discourse_name: "LLVM Discourse",
  llvm_discourse_desc: "The official discussion forum for the LLVM Compiler Infrastructure project. Covers developer RFCs, Clang, LLD, LLDB, MLIR, release announcements, and compiler architecture.",
  ...
  sfconservancy_name: "Software Freedom Conservancy",
  sfconservancy_desc: "Opens the Software Freedom Conservancy, a nonprofit providing legal, financial, and community support for free and open-source software projects.",
  gccmcf_name: "GCC MCF",
  ...
  wasm_chart_name: "WebAssembly Opcodes",
  wasm_chart_desc: "An interactive, quick-reference table for WebAssembly (WASM) opcodes, binary encodings, stack execution behaviors, and instruction specifications.",
  ...
  learncpp_desc: "LearnCpp is a comprehensive online resource for learning modern C++. It provides structured lessons, examples, and explanations covering C++ fundamentals, object‑oriented programming, templates, memory management, and advanced language features.",
  slingacademy_name: "SlingAcademy",
  slingacademy_desc: "Opens SlingAcademy, a site offering coding tutorials, programming guides, and developer learning resources.",
  ...
  publicapis_desc: "Opens Public APIs, a directory of free and open APIs across categories such as AI, data, utilities, and more.",
  githubstatus_name: "GitHub Status",
  ...
  noaiduckduckgo_name: "NO AI DuckDuckGo",
  noaiduckduckgo_desc: "A clutter-free, privacy-focused version of DuckDuckGo that completely strips away AI summaries, chat assistants, and complex scripts to deliver pure, traditional web search results.",
  getnomad_name: "Nomad",
  ...
  startpage_name: "Startpage",
  startpage_desc: "A premium privacy search engine that delivers genuine Google search results with total anonymity—acting as a protective shield for your data, much like DuckDuckGo does with Bing.",
  bravesearch_name: "Brave Search",
  bravesearch_desc: "A fully independent global search engine built from scratch by Brave. It offers unbiased, privacy-first search results without tracking your queries or building user profiles.",
  kagi_name: "Kagi Search",
  kagi_desc: "A premium, ad-free, and privacy-centric search engine driven by user subscriptions. It delivers high-quality, customizable results with zero tracking and powerful built-in developer tools.",
  mojeek_name: "Mojeek",
  mojeek_desc: "An independent, privacy-first search engine based in the UK that built its own web crawler and index from scratch, offering completely unbiased, non-tracking results.",
  searxng_name: "SearXNG Docs",
  ...
  stockcharts_desc: "Opens StockCharts, a platform for financial charting, technical analysis, and market data visualization.",
  ...
  barchart_desc: "Opens Barchart, a platform offering market data, charts, screeners, and analytics for stocks, futures, and options.",
  xe_name: "Xe",
  xe_desc: "Opens Xe, a platform providing real-time currency conversion, exchange rates, and international money transfer services.",
  exchangerates_name: "Exchange‑Rates.org",
  exchangerates_desc: "Opens Exchange‑Rates.org, a site providing real-time currency exchange rates, historical charts, and conversion tools.",
  ...
  vanguardinvestor_name: "Vanguard",
  vanguardinvestor_desc: "Opens Vanguard Investor, the official portal for managing Vanguard ETFs, mutual funds, and investment accounts.",
  ...
  moneycontrol_name: "Moneycontrol",
  moneycontrol_desc: "Opens Moneycontrol, a major financial platform offering market data, stock quotes, business news, and investment tools.",
  ...
  businessstandard_name: "Business Standard",
  businessstandard_desc: "Opens Business Standard, a leading Indian publication covering business, markets, policy, and economic analysis.",
  cryptopolitan_name: "Cryptopolitan",
  cryptopolitan_desc: "Opens Cryptopolitan, a news site covering cryptocurrency, blockchain, Web3 developments, and market analysis.",
  ...
  makeuseof_name: "MakeUseOf",
  makeuseof_desc: "Opens MakeUseOf, a site offering tech guides, software tutorials, device tips, and digital lifestyle advice.",
  pcguide_name: "PCGuide",
  ...
  iphoneincanada_name: "iPhone in Canada",
  iphoneincanada_desc: "Opens iPhone in Canada, a Canadian tech news site covering Apple updates, iPhone releases, telecom carriers, mobile plans, gadgets, and daily tech stories. Includes reviews, deals, how‑to guides, and coverage of major brands such as Apple, Google, Samsung, and Tesla.",
  gsmarena_name: "GSMArena",
  gsmarena_desc: "The ultimate resource for mobile phone specifications, news, and in-depth reviews.",
  ...
  fossdaily_name: "FOSS Daily",
  fossdaily_desc: "Opens FOSS Daily, a site featuring daily news and updates about free and open‑source software projects and communities.",
  ...
  iptvtools_name: "IPTV Live Sources (IPTV 直播源)",
  ...
  house_planner_name: "3D House Planner",
  house_planner_desc: "A web-based architectural tool to design and visualize floor plans and home interiors in 3D.",
  ...
  subtitletools_desc: "Opens SubtitleTools.com, an online suite for converting, syncing, cleaning, and translating subtitle files.",
  ...
  irishstar_name: "Irish Star",
  irishstar_desc: "Opens Irish Star, a news site focused on Irish-American stories, U.S. local news, culture, and entertainment.",
  ...
  democracynow_desc: "Opens Democracy Now!, an independent news program featuring global reporting and in‑depth interviews.",
  salon_name: "Salon",
  ...
  theatlantic_name: "The Atlantic",
  theatlantic_desc: "Opens The Atlantic, a magazine known for in‑depth reporting and commentary on politics, culture, technology, and society.",
  ...
  lawandcrime_name: "Law & Crime",
  lawandcrime_desc: "Opens Law & Crime, a legal news site featuring court cases, trials, crime reporting, and legal analysis.",
  livescience_name: "LiveScience",
  livescience_desc: "Opens LiveScience, a science news site covering discoveries, space, health, archaeology, and scientific explanations.",
  wbko_name: "WBKO",
  wbko_desc: "Opens WBKO, a local news station providing regional news, weather updates, and sports coverage in Kentucky.",
  westernjournal_name: "Western Journal",
  westernjournal_desc: "Opens Western Journal, a U.S. news and commentary site covering politics, society, current events, and opinion pieces.",
  mediaite_name: "Mediaite",
  mediaite_desc: "Opens Mediaite, a news site covering politics, media industry stories, and real-time commentary.",
  surprisingethics_name: "Surprising Ethics",
  surprisingethics_desc: "Opens Surprising Ethics, a podcast exploring the unexpected ethical questions raised by AI and modern technology.",
  myspa_name: "MySPA",
  myspa_desc: "Opens MySPA, the digital platform of Nikkan SPA!, a Japanese magazine featuring articles on culture, society, lifestyle, entertainment, and contemporary issues. Browse columns, long-form features, interviews, and trending topics from the online edition of SPA! magazine.",
  joshispa_name: "Joshi-SPA!",
  joshispa_desc: "Opens Joshi-SPA!, an online magazine offering articles on women's lifestyle, relationships, work, culture, and social issues. Features columns, interviews, trend coverage, and commentary from a female perspective.",
  ...
  wwd_name: "WWD",
  wwd_desc: "Opens WWD, a leading fashion industry publication covering style, beauty, retail, and luxury business news.",
  harpersbazaar_name: "Harper's Bazaar",
  harpersbazaar_desc: "Opens Harper's Bazaar, a leading fashion and culture magazine featuring style, beauty, luxury, and celebrity coverage.",
  thelist_name: "The List",
  thelist_desc: "Opens The List, a lifestyle and entertainment site covering celebrities, beauty, health, and pop culture.",
  ...
  linovelib_desc: "A Chinese light novel site (Linovelib, Bilinovel) offering Japanese anime-style web novels, rankings, tags, and downloadable formats. Features include full-series archives, user-curated popularity lists, and fast updates.",
  ...
  gying_name: "GYING (观影)",
  gying_desc: "Opens GYING, a streaming site offering a large collection of movies and shows available to watch for free.",
  afv_name: "AFV",
  afv_desc: "Opens AFV, the official site of America’s Funniest Home Videos featuring humorous clips and family entertainment.",
  dailymail_name: "Daily Mail",
  dailymail_desc: "Opens Daily Mail, a major UK news site featuring entertainment, world news, sports, lifestyle, and trending stories.",
  games_name: "Games",
  ...
  wordwalker_desc: "WordWalker is a themed language‑learning game that challenges players to choose the correct answers while exploring animated environments. It offers multiple themes and supports learning through repetition, hints, and visual engagement.",
  impresstochess_name: "Impressto Chess",
  impresstochess_desc: "Impressto Chess is a browser‑based chess game featuring clean visuals, smooth animations, and an intuitive interface. It allows players to practice, explore moves, and enjoy casual chess directly in the browser without installation.",
  trysolitaire_name: "TrySolitaire",
  trysolitaire_desc: "TrySolitaire is a free, ad‑free online solitaire site offering classic Klondike and multiple variations. It features smooth animations, beautiful cards, full‑screen play, and works instantly in the browser with no downloads or sign‑ups required.",
  gokuro_name: "Gokuro",
  ...
  huaweidog_desc: "A satirical parody site mocking Huawei marketing and recent meme events like the 'Bamboo Cicada' (Zhuzhiliao) controversy with interactive Web simulations.",
  bilibili_zhuzhiliao_name: "Bilibili Zhuzhiliao",
  ...
  gpa_memorymaps_name: "GPA Calculator (MemoryMaps)",
  gpa_memorymaps_desc: "A clean, efficient tool to calculate and track your Grade Point Average across different semesters.",
  gpa_io_name: "GPA Calculator (IO)",
  gpa_io_desc: "A popular online utility for calculating high school and college GPAs with support for weighted and unweighted scales.",
  unalengua_ipa_name: "Unalengua IPA Transcriber",
  unalengua_ipa_desc: "A powerful tool for transcribing text into International Phonetic Alphabet (IPA) symbols for multiple languages.",
  ...
  mingku_name: "Mingku Literature (名库文学)",
  ...
  chaoxingv8_name: "Chaoxing V8 (超星V8)",
  chaoxingv8_desc: "Opens Chaoxing V8, the portal for Chaoxing Learning used for courses, exams, and digital study resources.",
  ntuimooc_name: "Chaoxing iMooc (超星iMooc)",
  ntuimooc_desc: "Opens a Chaoxing‑based iMooc portal hosted under the NTU domain but not specific to Nantong University.",
  forums_name: "Forums",
  ...
  teamliquid_desc: "Opens Team Liquid, a global esports organization featuring news, rosters, match schedules, and community content.",
  steamcommunity_name: "Steam Community",
  ...
  wikimedia_commons_name: "Wikimedia Commons",
  wikimedia_commons_desc: "A giant database of freely usable images, sound, and other media files that anyone can contribute to and use.",
  seeklogo_name: "seeklogo",
  seeklogo_desc: "A comprehensive database and search engine for world's best brand vector logos and templates in various formats.",
  warcraft_wiki_name: "Warcraft Wiki",
  warcraft_wiki_desc: "Comprehensive fan-curated wiki for the Warcraft universe, covering World of Warcraft, Warcraft RTS, lore, game mechanics, quests, classes, and patches.",  religion_name: "Religion",
  ...
  sefaria_desc: "Opens Sefaria, a free online library of Jewish texts including Tanakh, Talmud, commentaries, and scholarly resources.",
  veducation_name: "Veducation",
  veducation_desc: "Opens Veducation Sanatan Library, a platform offering access to Gitas, Ramayanas, Vedas, Puranas, Upanishads, Sutras, Samhitas, and 1000+ Sanatan Shastras.",
  wanyouzhenyuan_name: "Wanyou Zhenyuan (万有真源)",
  wanyouzhenyuan_desc: "Opens Wanyou Zhenyuan, a platform focused on traditional Chinese culture, philosophy, and educational resources.",
  ...
  peertube_desc: "Opens PeerTube.tv, a decentralized video platform built on ActivityPub and peer-to-peer streaming.",
  ...
  whois_name: "Who.is",
  whois_desc: "Opens Who.is, a domain and IP lookup service providing WHOIS, RDAP, DNS, and nameserver information.",
  ...
  marinetraffic_desc: "Opens MarineTraffic, a global AIS-based platform for real-time vessel tracking, port activity, and maritime intelligence.",
  flightradar24_name: "Flightradar24",
  flightradar24_desc: "Opens Flightradar24, a global real-time flight tracking platform with ADS-B and radar data.",
  ...
  finbold_name: "Finbold",
  finbold_desc: "A fast-growing financial news and analysis platform providing extensive coverage of the stock market, cryptocurrency, fintech, banking, and global macroeconomic trends.",
  ...
  gdstudio_music_xyz_name: "GDStudio Music (Global Edition)",
  gdstudio_music_xyz_desc: "Full-featured global web music player by GDStudio without geographic restrictions. Features high-quality audio streaming, synchronized lyrics, and complete search functionality.",
  gdstudio_music_org_name: "GDStudio Music (Mainland China Scrapped Edition)",
  gdstudio_music_org_desc: "Direct-connection web music player by GDStudio optimized for users in Mainland China. Features smooth streaming, synchronized lyrics, and playlist management.",
  ...
  safeway_desc: "Safeway is a major grocery retailer in the United States, offering online shopping, delivery, and curbside pickup services. Customers can browse weekly deals, manage rewards, and order fresh produce, household essentials, and prepared foods through its website.",
  ...
  instacart_name: "Instacart",
  instacart_desc: "Opens Instacart, a U.S. grocery delivery and pickup service.",
  albertsons_name: "Albertsons",
  albertsons_desc: "Opens Albertsons, a major U.S. grocery store chain offering online shopping and delivery.",
  etsy_name: "Etsy",
  ...
  foodpandaph_name: "Foodpanda PH",
  foodpandaph_desc: "Opens Foodpanda Philippines, an online food and grocery delivery platform where users can order meals, snacks, drinks, essentials, and supermarket items from nearby restaurants and stores. Browse menus, track deliveries in real time, and enjoy convenient on-demand service across the Philippines.",
  grabfood_name: "GrabFood",
  grabfood_desc: "Opens GrabFood, Grab’s online food delivery service offering meals, drinks, snacks, and desserts from thousands of restaurants. Browse categories, view menus, place orders, and track your rider in real time across supported cities in Southeast Asia.",
  lenovo_us_name: "Lenovo US",
  ...
  tacojohns_order_name: "Taco John's Order",
  ...
  bk_china_recruitment_desc: "The official social recruitment portal for Burger King China. Explore job openings, submit applications for corporate and restaurant talent, and track your hiring status.",
  ...
  allrecipes_name: "Allrecipes",
  allrecipes_desc: "Opens Allrecipes, a large recipe platform featuring cooking guides, meal ideas, and community‑shared dishes.",
  ...
  expedia_name: "Expedia",
  expedia_desc: "Opens Expedia, a major U.S. travel platform for flights, hotels, and vacation packages.",
  cars_name: "Cars",
  tesla_name: "Tesla",
  ...
  pikpak_name: "PikPak",
  pikpak_desc: "A private cloud drive that allows you to save and play videos directly from the web with powerful offline download capabilities.",
  aws_name: "AWS",
  ...
  googlecloud_desc: "Opens Google Cloud, a global cloud computing platform offering compute, storage, AI, and enterprise services.",
  alibabacloud_name: "Alibaba Cloud",
  alibabacloud_desc: "Opens Alibaba Cloud, a global cloud platform offering compute, storage, networking, and enterprise cloud services.",
  aliyun_name: "Aliyun",
  aliyun_desc: "Opens Aliyun (China region), Alibaba's cloud platform offering compute, storage, security, and enterprise cloud services.",
  tencentcloud_name: "Tencent Cloud",
  tencentcloud_desc: "Opens Tencent Cloud, a global cloud platform offering compute, networking, databases, and AI services.",
  tencentcloudcn_name: "Tencent Cloud China",
  tencentcloudcn_desc: "Opens Tencent Cloud (China region), offering cloud compute, storage, networking, and enterprise services.",
  ...
  omniconvert_name: "OmniConvert",
  omniconvert_desc: "A free, open-source, and 100% private conversion toolkit that runs entirely client-side. Supports 94 file formats and 345 unit conversions without ever uploading your data.",
  ...
  toddvdating_desc: "Opens ToddV Dating, a site offering dating advice, courses, and relationship guidance.",
  ...
  ebpgesedna_name: "PauseLab (暂停实验室)",
  ebpgesedna_desc: "Opens PauseLab’s EBP module, a psychology-based training exercise built on evidence‑based behavioral practices.",
  prevention_name: "Prevention",
  prevention_desc: "Opens Prevention, a health and wellness site covering fitness, nutrition, mental health, and lifestyle guidance.",
  statefarm_name: "State Farm",
  statefarm_desc: "Opens State Farm, a major U.S. insurance and financial services provider.",
  uhs_name: "UHS",
  ...
  thespun_name: "The Spun",
  thespun_desc: "Opens The Spun, a sports news site covering college sports, NFL, NBA, MLB, and trending sports stories.",
  ...
  oupacademic_name: "Oxford Academic",
  oupacademic_desc: "Opens Oxford Academic, the scholarly publishing platform of Oxford University Press offering journals and academic research.",
  wenjuanxingcn_name: "Wenjuanxing (问卷星)",
  ...
  pwastoreio_desc: "PWAStore.io is a community-driven app store for Progressive Web Apps, offering discovery, trending apps, and instant installation without traditional app stores.",
  boards_name: "Boards",
  fourchan_name: "4chan",
...
// Microsoft Edge(Constructing...)
  ...
  marler8997_blog_name: "Ryan Marler's Blog",
  marler8997_blog_desc: "Technical blog by Ryan Marler (marler8997) exploring systems programming, compiler design, Zig, ABI compatibility, and low-level software engineering.",
...
// WeChat Mini Programs
  ...
  chinaemswechatmini_name: "EMS China Post Express Logistics (EMS中国邮政速递物流)",
  chinaemswechatmini_desc: "Official WeChat Mini Program for China Post EMS, offering parcel tracking and express delivery services.",
  chimelong_name: "Chimelong Tourism (长隆旅游)",
  chimelong_desc: "Opens the official Chimelong website, the central hub for all Chimelong resorts and attractions. Explore detailed information about Chimelong Safari Park, Ocean Kingdom, Paradise, Water Park, themed hotels, entertainment shows, and resort services across Guangzhou, Zhuhai, and Qingyuan. Access park guides, ticket details, hotel introductions, event updates, and comprehensive travel planning resources.",
  chimelongwechatmini_name: "Chimelong Tourism (长隆旅游)",
  chimelongwechatmini_desc: "Opens the Chimelong Tourism WeChat Mini Program, the official platform for accessing Chimelong’s theme parks, wildlife parks, ocean parks, water parks, and entertainment resorts. Browse and purchase tickets, book themed hotels, check show schedules, explore attractions in Guangzhou, Zhuhai, and Qingyuan, and enjoy a complete digital guide to the Chimelong vacation experience.",
  ...
  hushangrecycle_name: "Hushang Recycle (沪尚回收)",
  hushangrecycle_desc: "A localized recycling and green life service platform for the Shanghai area, offering on-demand waste collection, electronics trade-ins, and eco-friendly circular economy solutions.",
  ...
  fudanehall_name: "Fudan eHall (复旦eHall)",
  fudanehall_desc: "Fudan eHall is the university’s integrated service platform, providing students and staff with access to academic, administrative, and campus services through WeChat Mini Program.",
  ...
  bosidengmall_name: "Bosideng Mall (波司登商城)",
  bosidengmall_desc: "Bosideng Mall is the official WeChat Mini Program for Bosideng, offering online shopping for down jackets, apparel, seasonal collections, and member services within the WeChat ecosystem.",
  vipshop_name: "Vipshop Deals (唯品会特卖)",
  vipshop_desc: "Opens the Vipshop Deals mini program for browsing discounted fashion and lifestyle items.",
  applestorewechat_name: "Apple Store (Apple Store官方在线商店)",
  applestorewechat_desc: "Opens the Apple Store mini program for browsing and purchasing Apple products.",
  microsoftstorewechat_name: "Microsoft Store (微软官方商城)",
...
// native
  ...
  gcc_name: "GCC (GNU Compiler Collection)",
  gcc_desc: "Official homepage of the GNU Compiler Collection, providing documentation, releases, and manual pages for GCC. Note: Unadapted desktop legacy layout; text, fonts, and proportions will appear tiny or misaligned on mobile browsers without manual zooming.",
