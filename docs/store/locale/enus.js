...
// WeChat Mini Programs
  ...
  jsbchinacasual_desc: "A convenient financial service mini app by Jiangsu Bank, supporting various online transactions.",
  bocmicro_name: "BOC Microservices (中行微服务)",
  bocmicro_desc: "Official mini app from Bank of China offering account management, transfers, and core banking services.",
  icbcfinance_name: "ICBC Micro Finance (工行微金融)",
  icbcfinance_desc: "Microfinance platform by ICBC offering loan applications, wealth management, and more.",
  cmbmicro_name: "CMB Microservices (招行微服务)",
  cmbmicro_desc: "Mini app by China Merchants Bank for account inquiries, credit card management, and more.",
  bocom_name: "Bank of Communications (交通银行)",
  bocom_desc: "Official mini app from Bank of Communications offering account services and financial product access.",
  citicbank_name: "CITIC Bank (中信银行)",
  citicbank_desc: "Official mini app from China CITIC Bank offering account services, credit card tools, and financial products.",
  ...
  wulaoyaohotpot_name: "Wu Lao Yao Hotpot (吴老幺火锅)",
  wulaoyaohotpot_desc: "Official mini app of Wu Lao Yao Hotpot, offering online ordering and store locator features.",
