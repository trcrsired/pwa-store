...
// WeChat Mini Programs
  ...
  govservice_desc: "This (国家政务服务平台) WeChat Mini Program provides access to public services across China, including household registration, social security, healthcare, and travel documentation. It serves as a unified portal for citizens to manage official tasks and access government resources.",
  ...
  bosszhipin_desc: "BOSS Zhipin (BOSS直聘) is a direct-chat recruitment Mini Program that connects job seekers with hiring managers in real time. Users can browse openings, filter by location and role, and initiate conversations instantly—without intermediaries. The platform uses intelligent matching to recommend jobs based on resume and preferences.",
  yupaozhipin_name: "Yupao Zhipin",
  yupaozhipin_desc: "Yupao Zhipin (鱼泡直聘) is a recruitment platform focused on blue-collar and frontline jobs, spanning construction, logistics, manufacturing, and more. It supports instant messaging and direct calls to help job seekers connect quickly with employers.",
  hworldclub_name: "H World Club",
  hworldclub_desc: "H World Club (华住会) is the official hotel booking Mini Program by H World Group Limited, offering real-time reservations across 5,000+ hotels in 1,000+ cities. Members enjoy location-based search, instant booking, exclusive discounts, and unified loyalty points across brands like Hanting, Ji Hotel, and Orange Hotel.",
