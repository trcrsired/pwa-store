...
const L = {
  ...
  appleretailstore_name: "Apple Retail Store",
  appleretailstore_desc: "Apple Retail Store is Apple’s official physical store where customers can shop products, get technical support, and attend in-store sessions. Locations offer hands-on experiences with devices and personalized service from Apple Specialists.",
