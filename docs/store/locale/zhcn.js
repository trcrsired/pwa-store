...
const L = {
  ...
  wasmpass_desc: "WasmPass 是由本 PWA 商店作者编写的渐进式网络应用。它基于作者的 C++ fast_io 库示例，并通过编译为 WebAssembly 的 fast_io 库提供支持。GenPass 能够生成安全凭据，包括密码、用户名以及不同长度的 PIN，并支持特殊字符选项。数据可本地保存，项目基于 GPLv3 许可。",
